...
import 'package:demo/models/menus.dart';
...
class _ItemsUploadScreenState extends State<ItemsUploadScreen> {
  ...
  takeImage(mContext) {
    return showDialog(
        ...
        builder: (context) {
          return SimpleDialog(
            title: Text("Menu Image", style: TextStyle(
                color: foodbloodcolor,
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            leading: Icon(Icons.title, color: foodbloodcolor,),
            title: Container(
              width: 250,
              child: TextField(
          ...
          Divider(color: foodbloodcolor, thickness: 2,),
          ListTile(
            leading: Icon(Icons.description, color: foodbloodcolor,),
            title: Container(
              width: 250,
              child: TextField(
                style: TextStyle(color: Colors.black),
          ...
          Divider(color: foodbloodcolor, thickness: 2,),
          ListTile(
            leading: Icon(Icons.price_change, color: foodbloodcolor,),
            title: Container(
              width: 250,
              child: TextField(
                style: TextStyle(color: Colors.black),
  ...
  saveInfoToFirestore(String downloadUrl) {
    final ref = FirebaseFirestore.instance.collection("seller").doc(sharedPreferences!.getString("uid")).collection("menus")
